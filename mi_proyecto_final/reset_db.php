...
try {
    // Conectamos al servidor MySQL (sin seleccionar DB aún para poder borrarla)
    $conn = new mysqli($host, $user, $pass);
    
    // 1. Borrar y crear DB desde cero
    ...
    if ($conn->multi_query($sql)) {
        while ($conn->next_result()) {;} // Vaciar buffer de resultados
    }

    // 2.1 Insertar Categorías iniciales
    ...
    // 2.2 Insertar Libros de ejemplo
    // Nota: Se incluyen campos extra como ISBN y precio que se han añadido recientemente
    ...
    // Se usa una contraseña común '1234' para facilitar pruebas
    ...
    // Insertamos usuarios usando prepared statements
