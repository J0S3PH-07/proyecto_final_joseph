...
<div class="dashboard">
    <!-- Verificamos si existe una sesión de usuario activa -->
    <?php if (isset($_SESSION['user_id'])): ?>
        <div class="admin-panel">
            ...
            <!-- Mostramos contenido diferente según el rol del usuario -->
    ...
    <?php else: ?>
        <!-- Contenido para usuarios visitantes (no logueados) -->
        <div class="admin-panel">
